...
namespace Substrate.Unique.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AppPromotionStorage
    {
        ...
        public AppPromotionStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "Admin"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "Staked"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U32>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AppPromotion", "PendingUnstake"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT51)));
        ...
        /// </summary>
        public static string StakedParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
        ...
        /// </summary>
        public static string StakesPerAccountParams(Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  * **Value** - Amount of stakes.
        /// </summary>
        public async Task<Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT51> PendingUnstake(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AppPromotionStorage.PendingUnstakeParams(key);
            var result = await _client.GetStorageAsync<Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT51>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class AppPromotionConstants
    {
        ...
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.PalletId PalletId()
        {
            var result = new Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.PalletId();
        ...
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Types.Base.Arr16U8 FreezeIdentifier()
        {
            var result = new Substrate.Unique.NET.NetApiExt.Generated.Types.Base.Arr16U8();
