...
namespace Substrate.Unique.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class CouncilStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Proposals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Members"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Prime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public async Task<Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35> Proposals(string blockhash, CancellationToken token)
        {
            string parameters = CouncilStorage.ProposalsParams();
            var result = await _client.GetStorageAsync<Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  the proposal count at the time of creation was below threshold N).
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.HoldConsiderationT2>> CostOf(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = CouncilStorage.CostOfParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.HoldConsiderationT2>>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class CouncilCalls
    {
        ...
        public static Method SetMembers(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> new_members, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> prime, Substrate.NetApi.Model.Types.Primitive.U32 old_count)
        {
            ...
            return new Method(43, "Council", 0, "set_members", byteArray.ToArray());
        }
        ...
        public static Method Execute(Substrate.Unique.NET.NetApiExt.Generated.Model.unique_runtime.EnumRuntimeCall proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            ...
            return new Method(43, "Council", 1, "execute", byteArray.ToArray());
        }
        ...
        public static Method Propose(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> threshold, Substrate.Unique.NET.NetApiExt.Generated.Model.unique_runtime.EnumRuntimeCall proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            ...
            byteArray.AddRange(proposal.Encode());
            byteArray.AddRange(length_bound.Encode());
            return new Method(43, "Council", 2, "propose", byteArray.ToArray());
        }
        ...
        public static Method Vote(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Substrate.NetApi.Model.Types.Primitive.Bool approve)
        {
            ...
            return new Method(43, "Council", 3, "vote", byteArray.ToArray());
        }
        ...
        public static Method DisapproveProposal(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 proposal_hash)
        {
            ...
            return new Method(43, "Council", 5, "disapprove_proposal", byteArray.ToArray());
        }
        ...
        public static Method Close(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 proposal_hash, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Substrate.Unique.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight proposal_weight_bound, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            ...
            byteArray.AddRange(length_bound.Encode());
            return new Method(43, "Council", 6, "close", byteArray.ToArray());
        }
        ...
        public static Method Kill(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 proposal_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
            return new Method(43, "Council", 7, "kill", byteArray.ToArray());
        }
        ...
        public static Method ReleaseProposalCost(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 proposal_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
            return new Method(43, "Council", 8, "release_proposal_cost", byteArray.ToArray());
        }
    }
