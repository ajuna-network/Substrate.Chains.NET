...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.evm_core.error
{
    ...
    /// <summary>
    /// >> 436 - Variant[evm_core.error.ExitError]
    /// </summary>
    public sealed class EnumExitError : BaseEnumRust<ExitError>
    {
        ...
        public EnumExitError()
        {
				...
				AddTypeDecoder<Substrate.Unique.NET.NetApiExt.Generated.Model.evm_core.opcode.Opcode>(ExitError.InvalidCode);
				...
				AddTypeDecoder<Substrate.Unique.NET.NetApiExt.Generated.Types.Base.CowT1>(ExitError.Other);
