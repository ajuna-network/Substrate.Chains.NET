...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.dispatch
{
    ...
    /// <summary>
    /// >> 451 - Composite[frame_support.dispatch.PerDispatchClassT2]
    /// </summary>
    ...
    public sealed class PerDispatchClassT2 : BaseType
    {
        ...
        {
            var start = p;
            Normal = new Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system.limits.WeightsPerClass();
            Normal.Decode(byteArray, ref p);
            Operational = new Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system.limits.WeightsPerClass();
            Operational.Decode(byteArray, ref p);
            Mandatory = new Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system.limits.WeightsPerClass();
