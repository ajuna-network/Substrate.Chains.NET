...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.traits.messages
{
    ...
    /// <summary>
    /// >> 424 - Variant[frame_support.traits.messages.ProcessMessageError]
    /// </summary>
    public sealed class EnumProcessMessageError : BaseEnumRust<ProcessMessageError>
    {
        ...
        public EnumProcessMessageError()
        {
				...
				AddTypeDecoder<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight>(ProcessMessageError.Overweight);
