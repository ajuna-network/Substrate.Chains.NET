...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.frame_system
{
    ...
    /// <summary>
    /// >> 449 - Composite[frame_system.CodeUpgradeAuthorization]
    /// </summary>
    ...
    public sealed class CodeUpgradeAuthorization : BaseType
    {
        ...
        /// >> code_hash
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> check_version
        /// </summary>
        ...
        {
            var start = p;
            CodeHash = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
