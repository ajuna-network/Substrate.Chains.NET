...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.polkadot_primitives.v8
{
    
    
    /// <summary>
    /// >> 104 - Composite[polkadot_primitives.v8.PersistedValidationData]
    /// </summary>
    ...
    public sealed class PersistedValidationData : BaseType
    {
        ...
        /// >> parent_head
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.HeadData ParentHead { get; set; }
        /// <summary>
        /// >> relay_parent_number
        /// </summary>
        ...
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 RelayParentStorageRoot { get; set; }
        /// <summary>
        /// >> max_pov_size
        /// </summary>
        ...
        {
            var start = p;
            ParentHead = new Substrate.Unique.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.HeadData();
            ...
            RelayParentStorageRoot = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
