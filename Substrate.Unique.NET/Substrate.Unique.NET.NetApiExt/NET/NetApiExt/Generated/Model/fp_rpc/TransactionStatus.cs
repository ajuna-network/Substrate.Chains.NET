...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.fp_rpc
{
    
    
    /// <summary>
    /// >> 712 - Composite[fp_rpc.TransactionStatus]
    /// </summary>
    ...
    public sealed class TransactionStatus : BaseType
    {
        ...
        {
            var start = p;
            TransactionHash = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ...
            From = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H160();
            From.Decode(byteArray, ref p);
            To = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H160>();
            To.Decode(byteArray, ref p);
            ContractAddress = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H160>();
            ContractAddress.Decode(byteArray, ref p);
            Logs = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.log.Log>();
