...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.block
{
    
    
    /// <summary>
    /// >> 718 - Composite[ethereum.block.Block]
    /// </summary>
    ...
    public sealed class Block : BaseType
    {
        ...
        {
            var start = p;
            Header = new Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.header.Header();
            Header.Decode(byteArray, ref p);
            Transactions = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.EnumTransactionV2>();
            Transactions.Decode(byteArray, ref p);
            Ommers = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.header.Header>();
