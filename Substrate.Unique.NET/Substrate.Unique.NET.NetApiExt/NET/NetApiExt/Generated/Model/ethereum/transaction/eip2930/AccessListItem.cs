...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.eip2930
{
    ...
    /// <summary>
    /// >> 401 - Composite[ethereum.transaction.eip2930.AccessListItem]
    /// </summary>
    ...
    public sealed class AccessListItem : BaseType
    {
        ...
        {
            var start = p;
            Address = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H160();
            Address.Decode(byteArray, ref p);
            StorageKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256>();
