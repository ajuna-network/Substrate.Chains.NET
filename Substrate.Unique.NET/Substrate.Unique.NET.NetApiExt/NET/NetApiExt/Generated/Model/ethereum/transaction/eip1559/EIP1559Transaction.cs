...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.eip1559
{
    
    
    /// <summary>
    /// >> 402 - Composite[ethereum.transaction.eip1559.EIP1559Transaction]
    /// </summary>
    ...
    public sealed class EIP1559Transaction : BaseType
    {
        ...
        /// >> action
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.legacy.EnumTransactionAction Action { get; set; }
        /// <summary>
        /// >> value
        /// </summary>
        ...
        /// >> access_list
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.eip2930.AccessListItem> AccessList { get; set; }
        /// <summary>
        /// >> odd_y_parity
        /// </summary>
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Nonce = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            Nonce.Decode(byteArray, ref p);
            MaxPriorityFeePerGas = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            MaxPriorityFeePerGas.Decode(byteArray, ref p);
            MaxFeePerGas = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            MaxFeePerGas.Decode(byteArray, ref p);
            GasLimit = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            GasLimit.Decode(byteArray, ref p);
            Action = new Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.legacy.EnumTransactionAction();
            Action.Decode(byteArray, ref p);
            Value = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            ...
            AccessList = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.eip2930.AccessListItem>();
