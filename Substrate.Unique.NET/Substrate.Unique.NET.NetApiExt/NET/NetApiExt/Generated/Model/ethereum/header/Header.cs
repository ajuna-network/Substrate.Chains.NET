...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.header
{
    
    
    /// <summary>
    /// >> 719 - Composite[ethereum.header.Header]
    /// </summary>
    ...
    public sealed class Header : BaseType
    {
        ...
        {
            var start = p;
            ParentHash = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ParentHash.Decode(byteArray, ref p);
            OmmersHash = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
            OmmersHash.Decode(byteArray, ref p);
            Beneficiary = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H160();
            Beneficiary.Decode(byteArray, ref p);
            StateRoot = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
            StateRoot.Decode(byteArray, ref p);
            TransactionsRoot = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
            TransactionsRoot.Decode(byteArray, ref p);
            ReceiptsRoot = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ReceiptsRoot.Decode(byteArray, ref p);
            LogsBloom = new Substrate.Unique.NET.NetApiExt.Generated.Model.ethbloom.Bloom();
            LogsBloom.Decode(byteArray, ref p);
            Difficulty = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            Difficulty.Decode(byteArray, ref p);
            Number = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            ...
            GasUsed = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256();
            ...
            MixHash = new Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256();
            MixHash.Decode(byteArray, ref p);
            Nonce = new Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum_types.hash.H64();
