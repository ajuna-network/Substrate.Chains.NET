...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet
{
    ...
    /// <summary>
    /// >> 99 - Composite[pallet_state_trie_migration.pallet.MigrationTask]
    /// </summary>
    ...
    public sealed class MigrationTask : BaseType
    {
        ...
        {
            var start = p;
            ProgressTop = new Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.EnumProgress();
            ProgressTop.Decode(byteArray, ref p);
            ProgressChild = new Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.EnumProgress();
