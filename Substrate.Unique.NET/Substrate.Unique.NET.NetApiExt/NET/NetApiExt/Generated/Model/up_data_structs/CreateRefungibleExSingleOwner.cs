...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.up_data_structs
{
    ...
    /// <summary>
    /// >> 372 - Composite[up_data_structs.CreateRefungibleExSingleOwner]
    /// </summary>
    ...
    public sealed class CreateRefungibleExSingleOwner : BaseType
    {
        ...
        {
            var start = p;
            User = new Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr();
