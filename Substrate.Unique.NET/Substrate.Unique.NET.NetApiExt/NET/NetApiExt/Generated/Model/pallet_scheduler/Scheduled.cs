...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_scheduler
{
    
    
    /// <summary>
    /// >> 597 - Composite[pallet_scheduler.Scheduled]
    /// </summary>
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Unique.NET.NetApiExt.Generated.Types.Base.Arr32U8> MaybeId { get; set; }
        /// <summary>
        /// >> priority
        /// </summary>
        ...
        /// >> call
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded Call { get; set; }
        /// <summary>
        /// >> maybe_periodic
        /// </summary>
        ...
        {
            var start = p;
            MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Unique.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Substrate.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new Substrate.Unique.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
