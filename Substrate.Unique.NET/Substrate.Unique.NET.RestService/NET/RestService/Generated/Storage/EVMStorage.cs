...
namespace Substrate.Unique.NET.RestService.Generated.Storage
{
    ...
    public interface IEVMStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.log.Log> GetCurrentLogs();
    }
    ...
    public sealed class EVMStorage : IEVMStorage
    {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256> AccountStoragesTypedStorage
        {
            get
            {
        ...
        /// >> AccountStorages
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256 GetAccountStorages(string key)
        {
            if ((key == null))
            {
                return null;
        ...
        ///  Should be empty between transactions
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.log.Log> GetCurrentLogs()
        {
