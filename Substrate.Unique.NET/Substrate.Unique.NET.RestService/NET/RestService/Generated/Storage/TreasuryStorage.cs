...
namespace Substrate.Unique.NET.RestService.Generated.Storage
{
    ...
    public sealed class TreasuryStorage : ITreasuryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> _proposalsTypedStorage;
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> ProposalsTypedStorage
        {
            get
            {
        ...
        public Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key)
        {
            ...
            if (ProposalsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result))
            {
                return result;
            }
            else
