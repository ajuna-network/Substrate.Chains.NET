...
namespace Substrate.Unique.NET.RestService.Generated.Storage
{
    ...
    public sealed class CouncilStorage : ICouncilStorage
    {
        ...
        public CouncilStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.PrimeTypedStorage = new TypedStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Council.Prime", storageDataProvider, storageChangeDelegates);
        }
