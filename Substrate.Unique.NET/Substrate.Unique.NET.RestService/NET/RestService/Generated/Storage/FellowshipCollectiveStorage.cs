...
namespace Substrate.Unique.NET.RestService.Generated.Storage
{
    ...
    public interface IFellowshipCollectiveStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord GetMembers(string key);
        ...
        /// </summary>
        Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetIndexToId(string key);
        
        /// <summary>
        /// >> Voting
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord GetVoting(string key);
    ...
    public sealed class FellowshipCollectiveStorage : IFellowshipCollectiveStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord> _membersTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _indexToIdTypedStorage;
        
        /// <summary>
        /// _votingTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord> _votingTypedStorage;
        ...
        public FellowshipCollectiveStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.MembersTypedStorage = new TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord>("FellowshipCollective.Members", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord> MembersTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> IndexToIdTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord> VotingTypedStorage
        {
            get
            {
        ...
        ///  The current members of the collective.
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord GetMembers(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (MembersTypedStorage.Dictionary.TryGetValue(key, out Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord result))
            {
                return result;
            }
            else
        ...
        ///  return `Some`, however a member's index is not guaranteed to remain unchanged over time.
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetIndexToId(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (IndexToIdTypedStorage.Dictionary.TryGetValue(key, out Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord GetVoting(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VotingTypedStorage.Dictionary.TryGetValue(key, out Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord result))
            {
                return result;
            }
            else
