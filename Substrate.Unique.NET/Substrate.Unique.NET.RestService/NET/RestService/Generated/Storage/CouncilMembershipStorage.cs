...
namespace Substrate.Unique.NET.RestService.Generated.Storage
{
    ...
    public interface ICouncilMembershipStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 GetMembers();
    ...
    public sealed class CouncilMembershipStorage : ICouncilMembershipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37> _membersTypedStorage;
        ...
        {
            this.MembersTypedStorage = new TypedStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37>("CouncilMembership.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("CouncilMembership.Prime", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _membersTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37> MembersTypedStorage
        {
            get
            {
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 GetMembers()
        {
