...
namespace Substrate.Unique.NET.RestService.Generated.Controller
{
    ...
    public sealed class SchedulerController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.SchedulerStorage), "IncompleteSinceParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.SchedulerStorage), "AgendaParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
        ...
        /// </summary>
        [HttpGet("Retries")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.SchedulerStorage), "RetriesParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>))]
        ...
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.SchedulerStorage), "LookupParams", typeof(Substrate.Unique.NET.NetApiExt.Generated.Types.Base.Arr32U8))]
