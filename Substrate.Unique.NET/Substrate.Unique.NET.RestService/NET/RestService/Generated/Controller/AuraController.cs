...
namespace Substrate.Unique.NET.RestService.Generated.Controller
{
    ...
    public sealed class AuraController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.AuraStorage), "AuthoritiesParams")]
        ...
        /// </summary>
        [HttpGet("CurrentSlot")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.AuraStorage), "CurrentSlotParams")]
