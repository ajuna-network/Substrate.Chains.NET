...
namespace Substrate.Unique.NET.RestService.Generated.Controller
{
    ...
    public sealed class AuraExtController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("SlotInfo")]
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Unique.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot, Substrate.NetApi.Model.Types.Primitive.U32>), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.AuraExtStorage), "SlotInfoParams")]
