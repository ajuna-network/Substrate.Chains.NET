...
namespace Substrate.Unique.NET.RestService.Generated.Controller
{
    ...
    public sealed class BalancesController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.BalancesStorage), "TotalIssuanceParams")]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U128), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.BalancesStorage), "InactiveIssuanceParams")]
        ...
        /// </summary>
        [HttpGet("Account")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_balances.types.AccountData), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.BalancesStorage), "AccountParams", typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        /// </summary>
        [HttpGet("Locks")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.BalancesStorage), "LocksParams", typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        /// </summary>
        [HttpGet("Reserves")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24), 200)]
        ...
        /// </summary>
        [HttpGet("Holds")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT25), 200)]
