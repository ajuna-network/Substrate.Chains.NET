...
namespace Substrate.Unique.NET.RestService.Generated.Controller
{
    ...
    public sealed class FellowshipCollectiveController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage), "MemberCountParams", typeof(Substrate.NetApi.Model.Types.Primitive.U16))]
        ...
        /// </summary>
        [HttpGet("Members")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage), "MembersParams", typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        [HttpGet("IdToIndex")]
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U32), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage), "IdToIndexParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>))]
        ...
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage), "IndexToIdParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.NetApi.Model.Types.Primitive.U32>))]
        ...
        /// </summary>
        [HttpGet("Voting")]
        [ProducesResponseType(typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord), 200)]
        [StorageKeyBuilder(typeof(Substrate.Unique.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage), "VotingParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Unique.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>))]
